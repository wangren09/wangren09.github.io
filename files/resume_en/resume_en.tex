...
\item Designed and developed Texar-PyTorch (https://github.com/asyml/texar-pytorch, gaining over 545 stars), an open-source machine learning and text generation toolkit based on PyTorch. 
\item Maintained and contributed to Texar-TensorFlow (https://github.com/asyml/texar, gaining over 1880 stars), an open-source machine learning and text generation toolkit based on TensorFlow.
